...
ownerID = int("1076515841") #ايدي الادمن 
api_hash = "5e3eae2cd2d4c442c4f3489e62fd085b" #ايبي هاش 
api_id = 29151516 #ايبي ايدي
token = "6753077651:AAFFlL7aOPimpwfG9FC6X6DbdqJAn_c7XY0" #توكن البوت


bot = Client(
  'bot'+token.split(":")[0],
  29151516, #ايبي ايدي
 '5e3eae2cd2d4c442c4f3489e62fd085b', #ايبي هاش
